...
export default async function ToggleInfo({ authorId, dataId, path, from }: Props) {
  ...
  return (
    <aside className='relative h-full w-fit'>
      <details className='open:[&>summary>svg]:bg-neutral-700' name='toggleInfo'>
        ...
        <section className='absolute top-[26px] -right-0.5 z-5 flex w-48 flex-col items-start justify-center gap-1.5 rounded-md border border-neutral-800 bg-[#0a0a0a] text-neutral-200'>
